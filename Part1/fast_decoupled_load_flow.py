...
def FDCLF(Ybus, power_network, convergence, Q_max):
    ...
    while(True):
        if (i==0):
            ...
            V_updated, delta_updated, P_updated, Q_updated, V_vec_1, V_vec_2 = iterate_fdclf(num_buses, bus_num_init, V, V_vec_1, V_vec_2, delta, delta_vec_init, Ybus, bus_type_vec, P_vec_FD, Q_vec_FD, b_dash, b_double_dash, P, Q)
